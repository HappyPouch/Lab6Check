...
public class Canvas
{
    ...
    public static Canvas getCanvas()
    {
        if(canvasSingleton == null) {
            canvasSingleton = new Canvas("Car", 1000, 600, 
                                         Color.white);
        }
    ...
    public void setForegroundColor(String colorString)
    {
        if(colorString.equals("red"))
            ...
            {
                Color gold = new Color(213 , 0 , 0);
                graphic.setColor(gold);
            }
        else if(colorString.equals("darkGreen"))
            {
                Color darkGreen = new Color(38 , 127 , 0);
                graphic.setColor(darkGreen);
            }
        else if(colorString.equals("darkBlue"))
            {
                Color darkBlue = new Color(13 , 2 , 111);
                graphic.setColor(darkBlue);
            }
        else
            graphic.setColor(Color.black);
    }
